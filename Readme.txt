...
[IMGtoMOVIECustom]
①Texture:メインのテクスチャです。横に1コマずつ並べたような画像を指定してください。
②枚数:全部のコマ数を指定してください。
③毎目:枚数に対して今何枚目にいるのかの値です。(動画再生サイトなどでよくみるシークバーを数値化したものだと思ってください。)特にここはいじる必要ありませんが、30FPSの場合、一秒間に30フレーム進みますのでアニメーションの画面で一秒ごとに30枚流れるように設定してやってください。
